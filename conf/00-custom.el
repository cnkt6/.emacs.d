...
")))))
 ...
 '(package-selected-packages
   '(magit elpy py-autopep8 python-mode restart-emacs exec-path-from-shell use-package add-node-modules-path web-mode graphql-mode tide typescript-mode cmake-mode js2-mode slime ggtags agtags yatex sage-shell-mode flycheck yasnippet tuareg racer quickrun qml-mode org-preview-html multiple-cursors lua-mode init-loader htmlize haskell-mode google-c-style flymake-rust flymake-cursor flycheck-irony elscreen company buffer-move atom-dark-theme ac-slime)))
(custom-set-faces
